...
} from '@magicborn/video/workspace/video-template-workspace-contracts';
import { PAYLOAD_COLLECTIONS } from '../../payload-collections/enums';
import { makePayloadMediaResolver } from './payload-media-resolver';
import { VIDEO_TEMPLATE_PRESET_BY_ID, VIDEO_TEMPLATE_PRESETS } from '@magicborn/video/templates/presets';
