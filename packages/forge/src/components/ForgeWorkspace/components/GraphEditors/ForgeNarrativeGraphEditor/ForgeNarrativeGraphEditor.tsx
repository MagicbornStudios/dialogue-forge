...
import { type LayoutDirection } from '@magicborn/forge/lib/utils/forge-flow-helpers';
...
import { ChapterNode } from '@magicborn/forge/components/ForgeWorkspace/components/GraphEditors/shared/Nodes/components/ChapterNode/ChapterNode';
import { PageNode } from '@magicborn/forge/components/ForgeWorkspace/components/GraphEditors/shared/Nodes/components/PageNode/PageNode';
...
import type { ForgeGraphDoc, ForgeNode, ForgeNodeType, ForgeReactFlowNode } from '@magicborn/forge/types/forge-graph';
import { FORGE_NODE_TYPE } from '@magicborn/forge/types/forge-graph';

import { useSimpleForgeFlowEditor, type ShellNodeData } from '@magicborn/forge/lib/graph-editor/hooks/useSimpleForgeFlowEditor';
    ...
    >
        ...
        <div className={cn(
          ...
          <div className="ml-auto flex items-center gap-2">
            <GraphEditorToolbar
              scope="narrative"
              onCreateNew={handleCreateNewNarrative}
            />
            <button
        ...
        <div className="flex-1 flex overflow-hidden">
          <div className="flex-1 relative" ref={shell.reactFlowWrapperRef}>
            <ReactFlow
              nodes={nodesWithMeta}
              edges={edgesWithMeta}
              nodeTypes={nodeTypes}
        ...
        {/* For now, we'll skip it and add it in a follow-up if needed */}
          ...
          {/* Node Editor - shows when a node is selected */}
          {shell.selectedNode && (
            <NodeEditor
              node={shell.selectedNode}
              graph={shell.effectiveGraph}
              characters={characters}
              flagSchema={flagSchema}
