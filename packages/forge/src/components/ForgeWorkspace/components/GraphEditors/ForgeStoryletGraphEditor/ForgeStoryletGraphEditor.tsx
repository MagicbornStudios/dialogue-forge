...
import type { ForgeGameFlagState } from '@magicborn/shared/types/forge-game-state';
import { useFlowPathHighlighting } from '@magicborn/forge/lib/graph-editor/hooks/useFlowPathHighlighting';
...
import { NodeEditor } from '@magicborn/forge/components/ForgeWorkspace/components/GraphEditors/shared/NodeEditor/NodeEditor';
import { GraphLeftToolbar } from '@magicborn/forge/components/ForgeWorkspace/components/GraphEditors/shared/GraphLeftToolbar';
import { GraphLayoutControls } from '@magicborn/forge/components/ForgeWorkspace/components/GraphEditors/shared/GraphLayoutControls';
import { GraphMiniMap } from '@magicborn/forge/components/ForgeWorkspace/components/GraphEditors/shared/GraphMiniMap';
import { ForgeStoryletGraphEditorPaneContextMenu } from '@magicborn/forge/components/ForgeWorkspace/components/GraphEditors/ForgeStoryletGraphEditor/ForgeStoryletGraphEditorPaneContextMenu';

import { CharacterNode } from '@magicborn/forge/components/ForgeWorkspace/components/GraphEditors/shared/Nodes/components/CharacterNode/CharacterNode';
import { PlayerNode } from '@magicborn/forge/components/ForgeWorkspace/components/GraphEditors/shared/Nodes/components/PlayerNode/PlayerNode';
import { ConditionalNode } from '@magicborn/forge/components/ForgeWorkspace/components/GraphEditors/shared/Nodes/components/ConditionalNode/ConditionalNode';
import { StoryletNode } from '@magicborn/forge/components/ForgeWorkspace/components/GraphEditors/shared/Nodes/components/StoryletNode/StoryletNode';
import { ChoiceEdge } from '@magicborn/forge/components/ForgeWorkspace/components/GraphEditors/shared/Nodes/components/PlayerNode/ChoiceEdge';
import { ForgeEdge } from '@magicborn/forge/components/ForgeWorkspace/components/GraphEditors/shared/Edges/ForgeEdge';
...
import { CharacterEdgeDropMenu } from '@magicborn/forge/components/ForgeWorkspace/components/GraphEditors/shared/Nodes/components/CharacterNode/CharacterEdgeDropMenu';
import { PlayerEdgeDropMenu } from '@magicborn/forge/components/ForgeWorkspace/components/GraphEditors/shared/Nodes/components/PlayerNode/PlayerEdgeDropMenu';
import { ConditionalEdgeDropMenu } from '@magicborn/forge/components/ForgeWorkspace/components/GraphEditors/shared/Nodes/components/ConditionalNode/ConditionalEdgeDropMenu';
import { StoryletEdgeDropMenu } from '@magicborn/forge/components/ForgeWorkspace/components/GraphEditors/shared/Nodes/components/StoryletNode/StoryletEdgeDropMenu';
...
import {
  ...
  type ShellNodeData,
} from '@magicborn/forge/lib/graph-editor/hooks/useSimpleForgeFlowEditor';
...
export interface ForgeStoryletGraphEditorProps {
  ...
  gameState?: import('@magicborn/shared/types/forge-game-state').ForgeGameState;
