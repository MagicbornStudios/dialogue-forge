...
===`);
      ...
      expect(result.data?.conditionalBlocks?.[0].type).toBe(YARN_BLOCK_TYPE.IF);
...
===`);
      ...
      expect(result.data?.conditionalBlocks?.[0].type).toBe(YARN_BLOCK_TYPE.IF);
      expect(result.data?.conditionalBlocks?.[1].type).toBe(YARN_BLOCK_TYPE.ELSE);
    });
...
===`);
      ...
      expect(result.data?.conditionalBlocks?.[0].type).toBe(YARN_BLOCK_TYPE.IF);
      expect(result.data?.conditionalBlocks?.[1].type).toBe(YARN_BLOCK_TYPE.ELSEIF);
      expect(result.data?.conditionalBlocks?.[2].type).toBe(YARN_BLOCK_TYPE.ELSE);
    });
...
===`);
  ...
  describe('round-trip', () => {
    it('should round-trip if/else blocks', async () => {
      ...
      expect(imported.data?.conditionalBlocks?.[0].type).toBe(YARN_BLOCK_TYPE.IF);
      expect(imported.data?.conditionalBlocks?.[1].type).toBe(YARN_BLOCK_TYPE.ELSE);
    });
    ...
    it('should round-trip if/elseif/else blocks', async () => {
      ...
      expect(imported.data?.conditionalBlocks?.[0].type).toBe(YARN_BLOCK_TYPE.IF);
      expect(imported.data?.conditionalBlocks?.[1].type).toBe(YARN_BLOCK_TYPE.ELSEIF);
      expect(imported.data?.conditionalBlocks?.[2].type).toBe(YARN_BLOCK_TYPE.ELSE);
    });
  });
