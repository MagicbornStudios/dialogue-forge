import type { ForgeGraphDoc, ForgeReactFlowEdge, ForgeReactFlowNode, ForgeNodeType } from '@magicborn/forge/types/forge-graph';
import { isRuntimeOnlyNodeType } from '@magicborn/shared/types';
