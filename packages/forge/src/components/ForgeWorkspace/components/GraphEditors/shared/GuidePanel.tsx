...
import { FLAG_TYPE, FLAG_VALUE_TYPE } from '@magicborn/shared/types/constants';
...
export function GuidePanel({ isOpen, onClose }: GuidePanelProps) {
  ...
  const sections = {
    overview: {
      ...
      content: (
        <div className="space-y-4 text-sm">
          ...
          <h3 className="text-lg font-semibold mt-6 mb-2 text-df-text-primary">Node Types</h3>
          <div className="space-y-3">
            <div className="bg-df-surface p-3 rounded border border-[#2a2a3e]">
              <strong className="text-df-error">NPC Node</strong>
              <p className="text-df-text-secondary text-xs mt-1">Character dialogue. Has speaker name, dialogue text, and one output port (bottom circle) that connects to the next node.</p>
            </div>
            <div className="bg-df-surface p-3 rounded border border-[#2a2a3e]">
              <strong className="text-purple-400">Player Node</strong>
              <p className="text-df-text-secondary text-xs mt-1">Choice point with multiple options. Each choice has its own output port (right side circles) that can branch to different nodes.</p>
            </div>
          </div>


          <h3 className="text-lg font-semibold mt-6 mb-2 text-df-text-primary">Basic Workflow</h3>
          ...
          <h3 className="text-lg font-semibold mt-6 mb-2 text-df-text-primary">Creating Nodes</h3>
          ...
          <h3 className="text-lg font-semibold mt-6 mb-2 text-df-text-primary">Editing Nodes</h3>
          <ul className="list-disc list-inside space-y-1 text-sm ml-2">
          ...
          <h3 className="text-lg font-semibold mt-6 mb-2 text-df-text-primary">Connecting Nodes</h3>
          <ul className="list-disc list-inside space-y-1 text-sm ml-2">
    ...
    flags: {
      ...
      content: (
        <div className="space-y-4 text-sm">
          <div className="bg-[#1a2a3e] border-l-4 border-df-error p-4 rounded">
            <h3 className="text-df-text-primary font-semibold mb-2">Game State & Yarn Variables</h3>
          ...
          <h3 className="text-lg font-semibold mt-6 mb-2 text-df-text-primary">Game State Structure</h3>
          <p className="text-df-text-secondary mb-3">
...
const gameState: GameState = {
  ...
  characters: {
    ...
    bob: { hp: 30, name: 'Bob' },
          ...
          <h3 className="text-lg font-semibold mt-6 mb-2 text-df-text-primary">Automatic Flattening</h3>
          <p className="text-df-text-secondary mb-3">
            When you pass gameState to GamePlayer, it's automatically flattened into Yarn-compatible variables:
          </p>
          
          <div className="bg-df-surface p-4 rounded border border-[#2a2a3e]">
            <p className="text-gray-300 text-xs mb-2 font-semibold">Flattening Rules:</p>
            <ul className="list-disc list-inside space-y-1 text-xs text-df-text-secondary ml-2">
          ...
          <h3 className="text-lg font-semibold mt-6 mb-2 text-df-text-primary">Using in Yarn Conditions</h3>
          <p className="text-df-text-secondary mb-3">
...
<<endif>>`} language="yarn" />
          ...
          <h3 className="text-lg font-semibold mt-6 mb-2 text-df-text-primary">Flag Schema (For Editor)</h3>
          <p className="text-df-text-secondary mb-3">
...
// Use flattenGameState() for game state → variable mapping.`} language="typescript" />
          ...
          <div className="space-y-2 text-sm">
            <div className="bg-df-surface p-2 rounded border border-[#2a2a3e]">
            ...
            <div className="bg-df-surface p-2 rounded border border-[#2a2a3e]">
              <strong className="text-df-text-secondary">dialogue</strong> - Temporary, dialogue-scoped flags
            </div>
          </div>

          <h3 className="text-lg font-semibold mt-6 mb-2 text-df-text-primary">Best Practices</h3>
          <div className="space-y-2 text-sm">
            <div className="bg-df-surface p-3 rounded border border-[#2a2a3e]">
              <strong className="text-df-text-primary text-xs">1. Use descriptive names</strong>
              <p className="text-df-text-secondary text-xs mt-1">
                Flattened names should be clear: <code>$player_hp</code> not <code>$p_h</code>
              </p>
            </div>
            <div className="bg-df-surface p-3 rounded border border-[#2a2a3e]">
              <strong className="text-df-text-primary text-xs">2. Keep structures consistent</strong>
              <p className="text-df-text-secondary text-xs mt-1">
                Use the same game state structure throughout your app for predictable flattening
              </p>
            </div>
            <div className="bg-df-surface p-3 rounded border border-[#2a2a3e]">
              <strong className="text-df-text-primary text-xs">3. Characters as objects, not arrays</strong>
              <p className="text-df-text-secondary text-xs mt-1">
                Use <code>characters: {'{'} alice: {'{...}'} {'}'}</code> not <code>characters: [alice, ...]</code> for better naming
              </p>
            </div>
            <div className="bg-df-surface p-3 rounded border border-[#2a2a3e]">
              <strong className="text-df-text-primary text-xs">4. Only truthy values are included</strong>
              <p className="text-df-text-secondary text-xs mt-1">
    ...
    integration: {
      ...
      content: (
        <div className="space-y-4 text-sm">
          ...
          <h3 className="text-lg font-semibold mt-6 mb-2 text-df-text-primary">1. Install Package</h3>
          <div className="bg-df-surface p-4 rounded border border-[#2a2a3e]">
            <pre className="text-xs font-mono text-gray-300">npm install @magicborn/dialogue-forge</pre>
          </div>

          <h3 className="text-lg font-semibold mt-6 mb-2 text-df-text-primary">2. Define Flag Schema</h3>
...
const flagSchema: FlagSchema = {
  flags: [
    ...
    { id: 'stat_gold', type: FLAG_TYPE.STAT, valueType: FLAG_VALUE_TYPE.NUMBER, defaultValue: 0 },
          ...
          <h3 className="text-lg font-semibold mt-6 mb-2 text-df-text-primary">3. Load Dialogue from Yarn</h3>
...
const dialogue = importFromYarn(yarnContent, 'Merchant Dialogue');`} language="typescript" />
          ...
          <h3 className="text-lg font-semibold mt-6 mb-2 text-df-text-primary">4. Define Game State</h3>
          <p className="text-df-text-secondary text-sm mb-2">
...
const [gameState, setGameState] = useState<GameState>({
  ...
  player: {
    ...
    location: 'town',
          ...
          <h3 className="text-lg font-semibold mt-6 mb-2 text-df-text-primary">5. Edit Dialogue</h3>
...
/>`} language="typescript" />
          ...
          <h3 className="text-lg font-semibold mt-6 mb-2 text-df-text-primary">6. Define Game State</h3>
          <p className="text-df-text-secondary text-sm mb-2">
...
const gameState: GameState = {
  ...
  inventory: ['sword', 'potion'],
          ...
          <h3 className="text-lg font-semibold mt-6 mb-2 text-df-text-primary">7. Run Dialogue (Scene Player)</h3>
...
const yarnOutput = exportToYarn(dialogue);`} language="typescript" />
          ...
          <div className="space-y-3 text-sm">
            <div className="bg-df-surface p-3 rounded border border-[#2a2a3e]">
              <strong className="text-df-text-primary">1. Export to Yarn</strong>
              <p className="text-df-text-secondary text-xs mt-1">
                When you export, flags become Yarn commands: <code className="text-xs">&lt;&lt;set $quest_dragon_slayer = "started"&gt;&gt;</code>
              </p>
            </div>
            <div className="bg-df-surface p-3 rounded border border-[#2a2a3e]">
              <strong className="text-df-text-primary">2. Import to Unreal</strong>
              <p className="text-df-text-secondary text-xs mt-1">
    ...
    yarn: {
      ...
      content: (
        <div className="space-y-4 text-sm">
          ...
          <h3 className="text-lg font-semibold mt-6 mb-2 text-df-text-primary">Basic Syntax</h3>
          <div className="bg-df-surface p-4 rounded border border-[#2a2a3e]">
...
===`}
          ...
          <h3 className="text-lg font-semibold mt-6 mb-2 text-df-text-primary">Exporting</h3>
          <ol className="list-decimal list-inside space-y-2 text-sm ml-2">
            ...
            <li>Import the <code className="bg-df-surface px-1 rounded">.yarn</code> file into your game engine</li>
          </ol>

          <h3 className="text-lg font-semibold mt-6 mb-2 text-df-text-primary">Importing</h3>
          <ol className="list-decimal list-inside space-y-2 text-sm ml-2">
            <li>Click the <strong>Import</strong> button (upload icon)</li>
            <li>Select a <code className="bg-df-surface px-1 rounded">.yarn</code> file</li>
            <li>Nodes are automatically created from the Yarn structure</li>
            <li>Edit visually, then export again</li>
          </ol>
          
          <p className="text-df-text-secondary text-xs mt-3">
            <strong>Note:</strong> Flags are managed separately. Import/export flag schemas using the Flag Manager.
          </p>

          <h3 className="text-lg font-semibold mt-6 mb-2 text-df-text-primary">✅ Yarn Features Supported</h3>
          <div className="space-y-3">
            <div className="bg-df-surface p-3 rounded border border-[#2a2a3e]">
              <strong className="text-green-400 text-xs">Core Features</strong>
              <ul className="list-disc list-inside space-y-1 text-xs mt-2 ml-2 text-df-text-secondary">
                <li>Dialogue text with speakers (<code className="bg-df-canvas-bg px-1 rounded">Speaker: Text</code>)</li>
                <li>Player choices (<code className="bg-df-canvas-bg px-1 rounded">-&gt; Choice text</code>)</li>
                <li>Node structure (<code className="bg-df-canvas-bg px-1 rounded">title:</code>, <code className="bg-df-canvas-bg px-1 rounded">---</code>, <code className="bg-df-canvas-bg px-1 rounded">===</code>)</li>
              </ul>
            </div>
            ...
            <div className="bg-df-surface p-3 rounded border border-[#2a2a3e]">
              ...
              <ul className="list-disc list-inside space-y-1 text-xs mt-2 ml-2 text-df-text-secondary">
                <li>Flag setting (<code className="bg-df-canvas-bg px-1 rounded">&lt;&lt;set $flag = true&gt;&gt;</code>)</li>
                <li>Jumps (<code className="bg-df-canvas-bg px-1 rounded">&lt;&lt;jump node_id&gt;&gt;</code>)</li>
              </ul>
            </div>
            
            <div className="bg-df-surface p-3 rounded border border-green-500/30">
              <strong className="text-green-400 text-xs">✅ Conditional Blocks (Full Support)</strong>
              <ul className="list-disc list-inside space-y-1 text-xs mt-2 ml-2 text-df-text-secondary">
                <li><code className="bg-df-canvas-bg px-1 rounded">&lt;&lt;if condition&gt;&gt;</code> - Conditional dialogue blocks</li>
                <li><code className="bg-df-canvas-bg px-1 rounded">&lt;&lt;elseif condition&gt;&gt;</code> - Alternative conditions</li>
                <li><code className="bg-df-canvas-bg px-1 rounded">&lt;&lt;else&gt;&gt;</code> - Default fallback</li>
                <li><code className="bg-df-canvas-bg px-1 rounded">&lt;&lt;endif&gt;&gt;</code> - End conditional block</li>
              </ul>
              <p className="text-df-text-tertiary text-xs mt-2">Supports nested conditionals in NPC nodes with multiple blocks</p>
            </div>
            
            <div className="bg-df-surface p-3 rounded border border-green-500/30">
              <strong className="text-green-400 text-xs">✅ Conditional Choices</strong>
              <ul className="list-disc list-inside space-y-1 text-xs mt-2 ml-2 text-df-text-secondary">
                <li>Choices can have conditions that wrap them in <code className="bg-df-canvas-bg px-1 rounded">&lt;&lt;if&gt;&gt;</code> blocks</li>
            ...
            <div className="bg-df-surface p-3 rounded border border-green-500/30">
              ...
              <ul className="list-disc list-inside space-y-1 text-xs mt-2 ml-2 text-df-text-secondary">
                <li><code className="bg-df-canvas-bg px-1 rounded">is_set</code> - Check if flag exists</li>
                <li><code className="bg-df-canvas-bg px-1 rounded">is_not_set</code> - Check if flag doesn't exist</li>
                <li><code className="bg-df-canvas-bg px-1 rounded">==</code> - Equals</li>
                <li><code className="bg-df-canvas-bg px-1 rounded">!=</code> - Not equals</li>
                <li><code className="bg-df-canvas-bg px-1 rounded">&gt;</code> - Greater than</li>
                <li><code className="bg-df-canvas-bg px-1 rounded">&lt;</code> - Less than</li>
                <li><code className="bg-df-canvas-bg px-1 rounded">&gt;=</code> - Greater or equal</li>
                <li><code className="bg-df-canvas-bg px-1 rounded">&lt;=</code> - Less or equal</li>
              </ul>
            </div>
            
            <div className="bg-df-surface p-3 rounded border border-yellow-500/30">
              <strong className="text-yellow-400 text-xs">⚠️ Partially Supported</strong>
              <ul className="list-disc list-inside space-y-1 text-xs mt-2 ml-2 text-df-text-secondary">
                <li>Basic variable setting (<code className="bg-df-canvas-bg px-1 rounded">&lt;&lt;set $flag = true&gt;&gt;</code>) - Boolean only</li>
                <li>String/number variables - Not yet supported</li>
                <li>Variable operations (<code className="bg-df-canvas-bg px-1 rounded">+=</code>, <code className="bg-df-canvas-bg px-1 rounded">-=</code>, etc.) - Not yet supported</li>
                <li>Variable references in text (<code className="bg-df-canvas-bg px-1 rounded">"Hello {'{$name}'}"</code>) - Not yet supported</li>
              </ul>
            </div>
            
            <div className="bg-df-surface p-3 rounded border border-orange-500/30">
              <strong className="text-orange-400 text-xs">❌ Not Yet Supported</strong>
              <ul className="list-disc list-inside space-y-1 text-xs mt-2 ml-2 text-df-text-tertiary">
                <li><strong>Commands:</strong> <code className="bg-df-canvas-bg px-1 rounded">&lt;&lt;wait 2&gt;&gt;</code>, <code className="bg-df-canvas-bg px-1 rounded">&lt;&lt;stop&gt;&gt;</code>, <code className="bg-df-canvas-bg px-1 rounded">&lt;&lt;command param&gt;&gt;</code></li>
                <li><strong>Detour:</strong> <code className="bg-df-canvas-bg px-1 rounded">&lt;&lt;detour node_id&gt;&gt;</code> (temporary jump with return)</li>
                <li><strong>Once:</strong> <code className="bg-df-canvas-bg px-1 rounded">&lt;&lt;once&gt;&gt;</code> (options appear only once)</li>
                <li><strong>Shortcuts:</strong> <code className="bg-df-canvas-bg px-1 rounded">[[text|node]]</code> (inline navigation)</li>
                <li><strong>Tags:</strong> <code className="bg-df-canvas-bg px-1 rounded">#tag</code> (node metadata)</li>
                <li><strong>Node Headers:</strong> <code className="bg-df-canvas-bg px-1 rounded">color:</code>, <code className="bg-df-canvas-bg px-1 rounded">group:</code>, <code className="bg-df-canvas-bg px-1 rounded">style: note</code></li>
                <li><strong>Functions:</strong> <code className="bg-df-canvas-bg px-1 rounded">visited("node_id")</code>, <code className="bg-df-canvas-bg px-1 rounded">random(min, max)</code>, <code className="bg-df-canvas-bg px-1 rounded">dice(sides)</code></li>
            ...
            <div className="bg-df-surface p-3 rounded border border-blue-500/30 mt-3">
              <strong className="text-blue-400 text-xs">📋 Yarn Spinner Feature Roadmap</strong>
              <p className="text-xs text-df-text-secondary mt-2">
              ...
              <p className="text-xs text-df-text-tertiary mt-2 italic">
                See the Roadmap section for detailed implementation plans.
              </p>
            </div>
          </div>
          
          <h3 className="text-lg font-semibold mt-6 mb-2 text-df-text-primary">Example: Conditional Dialogue with If/Elseif/Else</h3>
          <div className="bg-df-surface p-4 rounded border border-[#2a2a3e]">
            <pre className="text-xs font-mono text-gray-300 whitespace-pre-wrap">
...
===`}
          ...
          <h3 className="text-lg font-semibold mt-6 mb-2 text-df-text-primary">Example: Conditional Choices</h3>
          <div className="bg-df-surface p-4 rounded border border-[#2a2a3e]">
            <pre className="text-xs font-mono text-gray-300 whitespace-pre-wrap">
...
===`}
          ...
          <h3 className="text-lg font-semibold mt-6 mb-2 text-df-text-primary">Example: Conditional Choices with Multiple Conditions</h3>
          <div className="bg-df-surface p-4 rounded border border-[#2a2a3e]">
            <pre className="text-xs font-mono text-gray-300 whitespace-pre-wrap">
{`title: merchant_shop
---
...
===`}
          ...
          <h3 className="text-lg font-semibold mt-6 mb-2 text-df-text-primary">Code Example</h3>
          <div className="bg-df-surface p-4 rounded border border-[#2a2a3e]">
        ...
        <div className="space-y-4 text-sm">
          <ul className="space-y-2">
            <li className="flex items-start gap-2">
              <kbd className="bg-df-surface px-2 py-1 rounded text-xs font-mono border border-[#2a2a3e]">Ctrl+Z</kbd>
              <span className="text-df-text-secondary">Undo last action (Cmd+Z on Mac)</span>
            </li>
            <li className="flex items-start gap-2">
              <kbd className="bg-df-surface px-2 py-1 rounded text-xs font-mono border border-[#2a2a3e]">Ctrl+Y</kbd>
              <span className="text-df-text-secondary">Redo last action (Cmd+Y on Mac)</span>
            </li>
            <li className="flex items-start gap-2">
              <kbd className="bg-df-surface px-2 py-1 rounded text-xs font-mono border border-[#2a2a3e]">Delete</kbd>
              <span className="text-df-text-secondary">Delete selected node(s) or edge(s)</span>
            </li>
            <li className="flex items-start gap-2">
              <kbd className="bg-df-surface px-2 py-1 rounded text-xs font-mono border border-[#2a2a3e]">Escape</kbd>
              <span className="text-df-text-secondary">Close menus, deselect node</span>
            </li>
            <li className="flex items-start gap-2">
              <kbd className="bg-df-surface px-2 py-1 rounded text-xs font-mono border border-[#2a2a3e]">Right-click</kbd>
              <span className="text-df-text-secondary">Context menu (on graph or node)</span>
            </li>
            <li className="flex items-start gap-2">
              <kbd className="bg-df-surface px-2 py-1 rounded text-xs font-mono border border-[#2a2a3e]">Scroll</kbd>
              <span className="text-df-text-secondary">Zoom in/out on graph</span>
            </li>
            <li className="flex items-start gap-2">
              <kbd className="bg-df-surface px-2 py-1 rounded text-xs font-mono border border-[#2a2a3e]">Drag</kbd>
              <span className="text-df-text-secondary">Pan the graph view (middle mouse or space + drag)</span>
            </li>
            <li className="flex items-start gap-2">
              <kbd className="bg-df-surface px-2 py-1 rounded text-xs font-mono border border-[#2a2a3e]">Drag node</kbd>
              <span className="text-df-text-secondary">Move node position</span>
            </li>
            <li className="flex items-start gap-2">
              <kbd className="bg-df-surface px-2 py-1 rounded text-xs font-mono border border-[#2a2a3e]">Drag port</kbd>
              <span className="text-df-text-secondary">Create connection to another node</span>
            </li>
            <li className="flex items-start gap-2">
              <kbd className="bg-df-surface px-2 py-1 rounded text-xs font-mono border border-[#2a2a3e]">Click + Drag</kbd>
              <span className="text-df-text-secondary">Select multiple nodes (selection box)</span>
            </li>
          </ul>
        </div>
      )
    ...
    roadmap: {
      ...
      content: (
        <div className="space-y-4 text-sm">
          ...
          <h3 className="text-lg font-semibold mt-6 mb-2 text-df-text-primary">✅ Recently Completed</h3>
          <div className="space-y-2">
            <div className="bg-df-surface p-3 rounded border border-green-500/30">
              <div className="flex items-start gap-2">
                <span className="text-green-500 text-xs">✅</span>
                <div>
                  <strong className="text-df-text-primary text-xs">React Flow Migration</strong>
                  <p className="text-df-text-secondary text-xs mt-1">Complete rewrite using React Flow with custom nodes, edges, and improved UX</p>
                </div>
              </div>
            </div>
            <div className="bg-df-surface p-3 rounded border border-green-500/30">
              <div className="flex items-start gap-2">
                <span className="text-green-500 text-xs">✅</span>
                <div>
                  <strong className="text-df-text-primary text-xs">Undo/Redo System</strong>
                  <p className="text-df-text-secondary text-xs mt-1">Action history with Ctrl+Z / Cmd+Z and Ctrl+Y / Cmd+Y (React Flow built-in)</p>
                </div>
              </div>
            </div>
            <div className="bg-df-surface p-3 rounded border border-green-500/30">
              <div className="flex items-start gap-2">
                <span className="text-green-500 text-xs">✅</span>
                <div>
                  <strong className="text-df-text-primary text-xs">Multi-Select & Delete</strong>
                  <p className="text-df-text-secondary text-xs mt-1">Selection box to select multiple nodes, bulk delete with Delete key (known issue: square selection doesn't always capture all nodes - deprioritized)</p>
                </div>
              </div>
            </div>
            <div className="bg-df-surface p-3 rounded border border-green-500/30">
              <div className="flex items-start gap-2">
                <span className="text-green-500 text-xs">✅</span>
                <div>
                  <strong className="text-df-text-primary text-xs">Minimap</strong>
                  <p className="text-df-text-secondary text-xs mt-1">Graph overview with navigation (React Flow built-in)</p>
                </div>
              </div>
            </div>
            <div className="bg-df-surface p-3 rounded border border-green-500/30">
              <div className="flex items-start gap-2">
                <span className="text-green-500 text-xs">✅</span>
                <div>
                  <strong className="text-df-text-primary text-xs">Edge Hover & Deletion</strong>
                  <p className="text-df-text-secondary text-xs mt-1">Edges highlight on hover and can be deleted by selecting and pressing Delete</p>
                </div>
              </div>
            </div>
          </div>
          
          <h3 className="text-lg font-semibold mt-6 mb-2 text-df-text-primary">In Progress</h3>
          <div className="space-y-2">
            <div className="bg-df-surface p-3 rounded border border-yellow-500/30">
              <div className="flex items-start gap-2">
                <span className="text-yellow-500 text-xs">🔄</span>
                <div>
                  <strong className="text-df-text-primary text-xs">Enhanced Yarn Spinner Support</strong>
                  <p className="text-df-text-secondary text-xs mt-1">Adding more Yarn Spinner features and improving graph node functionality</p>
                </div>
              </div>
            </div>
          </div>
          
          <h3 className="text-lg font-semibold mt-6 mb-2 text-df-text-primary">Planned (High Priority)</h3>
          <div className="space-y-2">
            <div className="bg-df-surface p-3 rounded border border-[#2a2a3e]">
              <div className="flex items-start gap-2">
                <span className="text-blue-500 text-xs">📋</span>
                <div>
                  <strong className="text-df-text-primary text-xs">Copy/Paste</strong>
                  <p className="text-df-text-secondary text-xs mt-1">Copy selected nodes and paste with offset, duplicate nodes with connections</p>
                </div>
              </div>
            </div>
            <div className="bg-df-surface p-3 rounded border border-[#2a2a3e]">
              <div className="flex items-start gap-2">
                <span className="text-blue-500 text-xs">📋</span>
                <div>
                  <strong className="text-df-text-primary text-xs">Variables System</strong>
                  <p className="text-df-text-secondary text-xs mt-1">Full Yarn variable support with UI for variable management</p>
                </div>
              </div>
            </div>
            <div className="bg-df-surface p-3 rounded border border-[#2a2a3e]">
              <div className="flex items-start gap-2">
                <span className="text-blue-500 text-xs">📋</span>
                <div>
                  <strong className="text-df-text-primary text-xs">Node Search/Filter</strong>
                  <p className="text-df-text-secondary text-xs mt-1">Search nodes by ID, content, or flags used</p>
                </div>
              </div>
            </div>
          </div>
          
          <h3 className="text-lg font-semibold mt-6 mb-2 text-df-text-primary">Planned (Medium Priority)</h3>
          <div className="space-y-2">
            <div className="bg-df-surface p-3 rounded border border-[#2a2a3e]">
              <div className="flex items-start gap-2">
                <span className="text-blue-500 text-xs">📋</span>
                <div>
                  <strong className="text-df-text-primary text-xs">Advanced Set Operations</strong>
                  <p className="text-df-text-secondary text-xs mt-1">Increment, decrement, multiply, divide for variables</p>
                </div>
              </div>
            </div>
            <div className="bg-df-surface p-3 rounded border border-[#2a2a3e]">
              <div className="flex items-start gap-2">
                <span className="text-blue-500 text-xs">📋</span>
                <div>
                  <strong className="text-df-text-primary text-xs">Commands Support</strong>
                  <p className="text-df-text-secondary text-xs mt-1">Yarn Spinner command nodes with parameters</p>
                </div>
              </div>
            </div>
            <div className="bg-df-surface p-3 rounded border border-[#2a2a3e]">
              <div className="flex items-start gap-2">
                <span className="text-blue-500 text-xs">📋</span>
                <div>
                  <strong className="text-df-text-primary text-xs">Node Alignment Tools</strong>
                  <p className="text-df-text-secondary text-xs mt-1">Align, distribute, and snap to grid</p>
                </div>
              </div>
            </div>
          </div>
          
          <h3 className="text-lg font-semibold mt-6 mb-2 text-df-text-primary">Known Issues</h3>
          <div className="space-y-2">
            <div className="bg-df-surface p-3 rounded border border-orange-500/30">
              <div className="flex items-start gap-2">
                <span className="text-orange-500 text-xs">⚠️</span>
                <div>
                  <strong className="text-df-text-primary text-xs">Square Selection</strong>
                  <p className="text-df-text-secondary text-xs mt-1">Selection box doesn't always capture all nodes within the selection area (deprioritized)</p>
                </div>
              </div>
            </div>
          </div>
    ...
    characters: {
      ...
      content: (
        <div className="space-y-4 text-sm">
          ...
          <h3 className="text-lg font-semibold mt-6 mb-2 text-df-text-primary">Character System</h3>
          ...
          <h3 className="text-lg font-semibold mt-6 mb-2 text-df-text-primary">Game State Structure</h3>
          <p className="text-gray-300 mb-3">
            Characters should be defined in your game state under the <code className="bg-df-canvas-bg px-1 rounded">characters</code> property:
          </p>
...
interface Character {
  ...
  description?: string;
          ...
          <h3 className="text-lg font-semibold mt-6 mb-2 text-df-text-primary">Using Characters</h3>
          <ol className="list-decimal list-inside space-y-2 text-sm ml-2 text-gray-300">
            <li><strong>Define characters</strong> in your game state with <code className="bg-df-canvas-bg px-1 rounded">id</code>, <code className="bg-df-canvas-bg px-1 rounded">name</code>, and optionally <code className="bg-df-canvas-bg px-1 rounded">avatar</code></li>
            <li><strong>Pass characters</strong> to <code className="bg-df-canvas-bg px-1 rounded">DialogueGraphEditor</code> via the <code className="bg-df-canvas-bg px-1 rounded">characters</code> prop</li>
          ...
          <h3 className="text-lg font-semibold mt-6 mb-2 text-df-text-primary">Example</h3>
...
/>`} language="typescript" />
    ...
    theming: {
      ...
      content: (
        <div className="space-y-4 text-sm">
          <p className="text-gray-300">
            Dialogue Forge uses Tailwind CSS theme variables that you can override in your application. All theme variables are prefixed with <code className="bg-df-canvas-bg px-1 rounded">df-</code> to avoid conflicts.
          </p>

          <h3 className="text-lg font-semibold mt-6 mb-2 text-df-text-primary">How to Override Theme</h3>
          <p className="text-gray-300 mb-3">
  ...
  --color-df-editor-border: oklch(0.30 0.03 250);
          ...
          <h3 className="text-lg font-semibold mt-6 mb-2 text-df-text-primary">Example: Custom Blue Theme</h3>
          <CodeBlock code={`@theme {
  ...
  --color-df-player-selected: oklch(0.65 0.25 300);
          ...
          <div className="bg-[#1a2a3e] border-l-4 border-blue-500 p-4 rounded mt-4">
            <p className="text-gray-300 text-xs">
              <strong>Note:</strong> All Dialogue Forge components use these theme classes (e.g., <code className="bg-df-canvas-bg px-1 rounded">bg-df-npc-bg</code>, <code className="bg-df-canvas-bg px-1 rounded">text-df-text-primary</code>). By overriding the CSS variables, you change the colors throughout the entire editor without modifying any component code.
            </p>
          </div>
        </div>
      )
  ...
  return (
    <div className="fixed inset-0 bg-black/70 z-50 flex items-center justify-center p-4" onClick={onClose}>
      <div 
        className="bg-df-canvas-bg border border-[#1a1a2e] rounded-xl max-w-5xl w-full max-h-[90vh] overflow-hidden flex"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Sidebar */}
        <div className="w-64 border-r border-[#1a1a2e] bg-df-surface flex flex-col">
          <div className="p-4 border-b border-[#1a1a2e]">
            <h2 className="text-lg font-semibold text-df-text-primary">Guide</h2>
          </div>
            ...
            {Object.entries(sections).map(([key, section]) => (
              <button
                ...
                className={`w-full text-left px-3 py-2 rounded text-sm transition-colors mb-1 ${
                  activeSection === key
                    ? 'bg-[#e94560] text-df-text-primary'
                    : 'text-df-text-secondary hover:text-df-text-primary hover:bg-[#1a1a2e]'
                }`}
              >
                {section.title}
              </button>
        ...
        <div className="flex-1 overflow-y-auto p-6">
          <div className="max-w-none">
            <h1 className="text-2xl font-bold text-df-text-primary mb-4">
        ...
        <button
          onClick={onClose}
          className="absolute top-4 right-4 p-2 text-df-text-secondary hover:text-df-text-primary"
        >
