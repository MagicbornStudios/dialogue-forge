...
import { EdgePulseAnimation, LoopIndicator, LoopArrowMarker } from '../../../shared/EdgeSVGElements';
import {
  ContextMenu,
  ContextMenuContent,
  ContextMenuItem,
...
export function CharacterEdge({
  ...
  const edge = { sourceHandle: data?.sourceHandle } as ForgeFlowEdge;
