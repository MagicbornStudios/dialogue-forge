...
import type { ForgeReactFlowNode } from '@magicborn/forge/types/forge-graph';
import { EdgePulseAnimation, LoopIndicator } from '@magicborn/forge/components/ForgeWorkspace/components/GraphEditors/shared/Nodes/components/shared/EdgeSVGElements';
import {
  ContextMenu,
  ContextMenuContent,
  ContextMenuItem,
