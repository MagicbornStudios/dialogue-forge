...
import type { FlagDefinition } from '@/forge/types/flags';
import { flagTypeColors, flagTypeLabels } from '@/forge/components/ForgeWorkspace/components/GraphEditors/ForgeWorkSpaceModals/components/ForgeFlagManagerModal/FlagManager/utils/flag-constants';

interface ForgeFlagCardProps {
  flag: FlagDefinition;
  isUsed: boolean;
...
export function ForgeFlagCard({ flag, isUsed, onEdit, onDelete }: ForgeFlagCardProps) {
  return (
    <Card
