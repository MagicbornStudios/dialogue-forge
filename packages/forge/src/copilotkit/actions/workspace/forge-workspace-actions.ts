...
import type { ForgeWorkspaceState } from '@magicborn/forge/components/ForgeWorkspace/store/forge-workspace-store';
import type { Parameter } from '@copilotkit/shared';
import type { FrontendAction } from '@copilotkit/react-core';
import { FORGE_ACTION_NAME } from '@magicborn/forge/copilotkit/constants/forge-action-names';
import { GRAPH_SCOPE } from '@magicborn/forge/types/constants';
import { FORGE_GRAPH_KIND, FORGE_NODE_TYPE } from '@magicborn/forge/types/forge-graph';
