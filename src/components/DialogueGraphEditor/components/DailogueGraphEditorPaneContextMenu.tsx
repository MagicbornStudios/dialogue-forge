...
interface DailogueGraphEditorPaneContextMenuProps {
  x: number;
  y: number;
  graphX: number;
  graphY: number;
...
const availableNodeTypes: NodeType[] = [NODE_TYPE.NPC, NODE_TYPE.PLAYER, NODE_TYPE.CONDITIONAL];

export function DailogueGraphEditorPaneContextMenu({
  x,
  y,
  graphX,
  graphY,
  onAddNode,
  onClose,
}: DailogueGraphEditorPaneContextMenuProps) {
  return (
