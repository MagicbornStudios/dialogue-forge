 ...
 * @example
 * ```typescript
 * import { FLAG_TYPE, FlagSchema } from '@magicborn/forge';
 * 
...
import { ConditionOperatorSymbol, FLAG_TYPE, FLAG_VALUE_TYPE, type FlagValueType } from './constants';
...
export interface FlagReference {
  flagId: string;
  operator?: ConditionOperatorSymbol;
