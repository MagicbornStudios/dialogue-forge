...
For agents. This folder is the canonical place for migration plans and parity docs.
...
2. Read [11-out-of-scope.md](11-out-of-scope.md).
3. Read the specific plan you are executing (30-33) and [docs/agent-artifacts/core/STATUS.md](../../agent-artifacts/core/STATUS.md).
...
- [12-yarn-spinner-alignment.md](12-yarn-spinner-alignment.md)
- [20-dialogue-forge-inventory.md](20-dialogue-forge-inventory.md)
- [21-writer-forge-inventory.md](21-writer-forge-inventory.md)
- [22-node-and-inspector-mapping.md](22-node-and-inspector-mapping.md)
- [30-plan-yarn-and-graph-types.md](30-plan-yarn-and-graph-types.md)
- [31-plan-nodes-and-inspector.md](31-plan-nodes-and-inspector.md)
- [32-plan-writer-and-pages.md](32-plan-writer-and-pages.md)
