...
## When to edit
- **Runtime constants or types** (directives, frame kinds) → [packages/shared/src/types/runtime.ts](packages/shared/src/types/runtime.ts).
- **Yarn export behavior** (what gets stripped or preserved) → [packages/forge/src/lib/yarn-converter/](packages/forge/src/lib/yarn-converter/).
