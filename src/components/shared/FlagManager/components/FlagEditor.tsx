...
import type { FlagDefinition, FlagValueType } from '@/src/types/flags';
import { FLAG_TYPE, FLAG_VALUE_TYPE } from '@/src/types/constants';
import { flagTypeColors, flagTypeLabels, flagTypes } from '../utils/flag-constants';
...
export function FlagEditor({ flag, categories, onSave, onCancel }: FlagEditorProps) {
