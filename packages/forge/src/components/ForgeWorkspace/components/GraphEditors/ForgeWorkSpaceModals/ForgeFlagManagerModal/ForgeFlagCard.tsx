...
import { Card } from '@magicborn/shared/ui/card';
import { Badge } from '@magicborn/shared/ui/badge';
import { Button } from '@magicborn/shared/ui/button';
import type { FlagDefinition } from '@magicborn/forge/types/flags';
import { flagTypeColors, flagTypeLabels } from '@magicborn/forge/lib/flag-manager/utils/flag-constants';
