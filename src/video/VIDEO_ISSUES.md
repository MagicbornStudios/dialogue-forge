...
### Debt #2: Multiple Entry Points
**Current**:
- `VideoWorkspace.tsx` (new, complete)
- `VideoTemplateWorkspace.tsx` (legacy, incomplete)

**Recommendation**: Deprecate VideoTemplateWorkspace
