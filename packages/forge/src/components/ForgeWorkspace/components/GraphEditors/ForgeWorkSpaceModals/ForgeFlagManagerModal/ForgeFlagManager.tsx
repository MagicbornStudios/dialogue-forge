...
import { useFlagManager } from '@magicborn/forge/lib/flag-manager/hooks/useFlagManager';
import { useUsedFlags } from '@magicborn/forge/lib/flag-manager/hooks/useUsedFlags';
...
function ForgeFlagManagerContent({
  ...
  const handleSaveFlag = (flag: import('@magicborn/forge/types/flags').FlagDefinition) => {
    if (isCreating) {
      onUpdate({
        ...flagSchema,
