...
import type { ConditionOperator } from '@magicborn/shared/types/constants';
import type { RuntimeDirectiveApplyMode, RuntimeDirectiveType } from '@magicborn/shared/types/runtime';
